 ...
 * @author dosen
 */
public class DlgPropinsi2 extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgPropinsi2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgPropinsi2 dialog = new DlgPropinsi2(new javax.swing.JFrame(), true);
    ...
    private void tampil() {
        ...
        try{     
            ps=koneksi.prepareStatement("select nm_prop,kd_prop from propinsi2 where nm_prop like ? ");
            try {
