...
public class DlgBilingRanap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        KwitansiDeposit = new widget.Button();
        KwitansiTotal = new widget.Button();
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "24-07-2021 08:49:00" }));
        ...
        KwitansiDeposit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Edit.png"))); // NOI18N
        KwitansiDeposit.setMnemonic('B');
        KwitansiDeposit.setText("Kwitansi Pengembalian Deposit");
        KwitansiDeposit.setToolTipText("Alt+B");
        KwitansiDeposit.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        KwitansiDeposit.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        KwitansiDeposit.setMargin(new java.awt.Insets(4, 8, 4, 8));
        KwitansiDeposit.setMaximumSize(new java.awt.Dimension(230, 30));
        KwitansiDeposit.setMinimumSize(new java.awt.Dimension(230, 30));
        KwitansiDeposit.setName("KwitansiDeposit"); // NOI18N
        KwitansiDeposit.setPreferredSize(new java.awt.Dimension(250, 30));
        KwitansiDeposit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                KwitansiDepositActionPerformed(evt);
            }
        });
        KwitansiDeposit.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KwitansiDepositKeyPressed(evt);
            }
        });
        panelGlass2.add(KwitansiDeposit);

        KwitansiTotal.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Edit.png"))); // NOI18N
        KwitansiTotal.setMnemonic('B');
        KwitansiTotal.setText("Kwitansi Total Tagihan");
        KwitansiTotal.setToolTipText("Alt+B");
        KwitansiTotal.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        KwitansiTotal.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        KwitansiTotal.setMargin(new java.awt.Insets(4, 8, 4, 8));
        KwitansiTotal.setMaximumSize(new java.awt.Dimension(230, 30));
        KwitansiTotal.setMinimumSize(new java.awt.Dimension(230, 30));
        KwitansiTotal.setName("KwitansiTotal"); // NOI18N
        KwitansiTotal.setPreferredSize(new java.awt.Dimension(250, 30));
        KwitansiTotal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                KwitansiTotalActionPerformed(evt);
            }
        });
        KwitansiTotal.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                KwitansiTotalKeyPressed(evt);
            }
        });
        panelGlass2.add(KwitansiTotal);
...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
        ...
        if(TNoRw.getText().trim().equals("")||TNoRM.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            try{
                ...
                try{
                      ...
                      biaya = (String)JOptionPane.showInputDialog(null,"Silahkan pilih nota yang mau dicetak!","Nota",JOptionPane.QUESTION_MESSAGE,null,new Object[]{"Nota", "Kwitansi Pelunasan Pembayaran", "Nota & Kwitansi","Kwitansi Piutang"},"Nota");
                      switch (biaya) {
                            case "Nota":
                                  i=1;
                                  break;
                            //case "Nota 2":
                                  //i=2;
                                  //break;
                            case "Kwitansi Pelunasan Pembayaran":
                                  i=3;
                                  break;
                            case "Nota & Kwitansi":
                                  i=4;
    ...
    private void KwitansiDepositActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KwitansiDepositActionPerformed
        i=Sequel.cariInteger("select count(billing.no_rawat) from billing where billing.no_rawat=?",TNoRw.getText());
        if(TNoRw.getText().trim().equals("")||TNoRM.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            Valid.textKosong(TNoRw,"Pasien");
        }else if(tbBilling.getRowCount()==0){
            ...
            try{
                ...
                try{
                      //biaya = (String)JOptionPane.showInputDialog(null,"Silahkan pilih nota yang mau dicetak!","Nota",JOptionPane.QUESTION_MESSAGE,null,new Object[]{"Nota 1", "Nota 2", "Kwitansi", "Nota & Kwitansi","Kwitansi Piutang"},"Nota 1");
                      biaya = (String)JOptionPane.showInputDialog(null,"Silahkan pilih Kwitansi yang mau dicetak!","Kwitansi",JOptionPane.QUESTION_MESSAGE,null,new Object[]{"Kwitansi Pengembalian Deposit"},"Kwitansi");
                      switch (biaya) {
                            //case "Nota 1":
                                  //i=1;
                                  //break;
                            //case "Nota 2":
                                  //i=2;
                                  //break;
                            case "Kwitansi Pengembalian Deposit":
                                  i=3;
                                  break;
                            //case "Nota & Kwitansi":
                                  //i=4;
                ...
                if(i>0){                       
                    ...
                    if(i==1){
                        ...
                        if(piutang>0){
                            ...
                            Valid.panggilUrl("billing/LaporanBillingPengembalianDeposit.php?petugas="+akses.getkode().replaceAll(" ","_")+"&nonota="+Sequel.cariIsi("select count(kamar_inap.no_rawat) from kamar_inap inner join reg_periksa "+
                                    "on kamar_inap.no_rawat=reg_periksa.no_rawat where reg_periksa.kd_pj='"+kd_pj+"' and kamar_inap.tgl_keluar like '%"+Valid.SetTgl(DTPTgl.getSelectedItem()+"").substring(0,7)+"%'")+"/RI/"+kd_pj+"/"+Valid.SetTgl(DTPTgl.getSelectedItem()+"").substring(5,7)+"/"+Valid.SetTgl(DTPTgl.getSelectedItem()+"").substring(0,4));
                        }                            
                    }else if(i==4){
                        ttl=(ttlLaborat+ttlRadiologi+ttlOperasi+ttlObat+ttlRanap_Dokter+ttlRanap_Paramedis+ttlRalan_Dokter+
    ...
    }//GEN-LAST:event_KwitansiDepositActionPerformed

    private void KwitansiDepositKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KwitansiDepositKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_KwitansiDepositKeyPressed
    ...
    private void KwitansiTotalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KwitansiTotalActionPerformed
               i=Sequel.cariInteger("select count(billing.no_rawat) from billing where billing.no_rawat=?",TNoRw.getText());
        if(TNoRw.getText().trim().equals("")||TNoRM.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            Valid.textKosong(TNoRw,"Pasien");
        }else if(tbBilling.getRowCount()==0){
            ...
            try{
                ...
                try{
                      //biaya = (String)JOptionPane.showInputDialog(null,"Silahkan pilih nota yang mau dicetak!","Nota",JOptionPane.QUESTION_MESSAGE,null,new Object[]{"Nota 1", "Nota 2", "Kwitansi", "Nota & Kwitansi","Kwitansi Piutang"},"Nota 1");
                      biaya = (String)JOptionPane.showInputDialog(null,"Silahkan pilih Kwitansi yang mau dicetak!","Kwitansi",JOptionPane.QUESTION_MESSAGE,null,new Object[]{"Kwitansi Total Tagihan"},"Kwitansi");
                      switch (biaya) {
                            //case "Nota 1":
                                  //i=1;
                                  //break;
                ...
                if(i>0){                       
                    ...
                    if(i==1){
                        ...
                        if(piutang>0){
                            ...
                            Valid.panggilUrl("billing/LaporanBillingTotal.php?petugas="+akses.getkode().replaceAll(" ","_")+"&nonota="+Sequel.cariIsi("select count(kamar_inap.no_rawat) from kamar_inap inner join reg_periksa "+
                                    "on kamar_inap.no_rawat=reg_periksa.no_rawat where reg_periksa.kd_pj='"+kd_pj+"' and kamar_inap.tgl_keluar like '%"+Valid.SetTgl(DTPTgl.getSelectedItem()+"").substring(0,7)+"%'")+"/RI/"+kd_pj+"/"+Valid.SetTgl(DTPTgl.getSelectedItem()+"").substring(5,7)+"/"+Valid.SetTgl(DTPTgl.getSelectedItem()+"").substring(0,4));
                        }                            
                    }else if(i==4){
                        ttl=(ttlLaborat+ttlRadiologi+ttlOperasi+ttlObat+ttlRanap_Dokter+ttlRanap_Paramedis+ttlRalan_Dokter+
    ...
    }//GEN-LAST:event_KwitansiTotalActionPerformed

    private void KwitansiTotalKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KwitansiTotalKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_KwitansiTotalKeyPressed
    ...
    */
    ...
    private widget.Button KwitansiDeposit;
    private widget.Button KwitansiTotal;
